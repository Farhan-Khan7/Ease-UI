  ...
  const features = [
    {
      ...
      description:
        "Built with performance in mind. Zero runtime overhead and optimized bundle size.",
    },
    {
      icon: <Palette className="w-6 h-6" />,
      title: "Beautiful Design",
      description:
        "Modern, clean components with consistent design system and smooth animations.",
    },
    {
      icon: <Code className="w-6 h-6" />,
      title: "Developer Friendly",
      description:
        "Type-safe, well-documented components with intuitive API for rapid development.",
    },
    {
      icon: <Sparkles className="w-6 h-6" />,
      title: "Fully Customizable",
      description:
        "Easily customize themes, colors, and styles to match your brand identity.",
    },
  ];
      ...
      <LayoutContent className="bg-[var(--bg-color)]">
        ...
        <section className="relative px-8  pb-32 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto text-center">
            ...
            >
              A modern React component library designed for developers who value
              aesthetics, performance, and simplicity.
            </p>
        ...
        <section className="px-8 py-24 bg-gradient-to-br from-blue-600 to-purple-600">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-white/80 mb-10">
              Join thousands of developers using EaseUI to create beautiful
              applications
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button
